...
export function Modal({ title, open, onClose, link, children }: ModalProps) {
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-end justify-center bg-slate-900/60 p-4 backdrop-blur-sm">
      <div className="no-scrollbar max-h-[85%] w-full overflow-y-auto rounded-2xl border border-slate-100 bg-white p-5 shadow-2xl">
        ...
        <div className="mb-5 space-y-3 text-xs leading-relaxed text-slate-600">{children}</div>
