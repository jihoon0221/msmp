      ...
      <div className="relative flex h-[880px] max-h-[calc(100vh-2rem)] w-full max-w-[390px] flex-col overflow-hidden rounded-3xl border-[10px] border-slate-800 bg-slate-950 shadow-2xl">
        <div className="absolute inset-x-0 top-0 z-50 flex h-6 items-center justify-between bg-slate-900 px-6 text-[10px] text-slate-300">
          ...
          <div className="absolute left-1/2 top-0 flex h-4 w-24 -translate-x-1/2 items-center justify-center rounded-b-xl bg-slate-900">
            <span className="mr-1 block h-2.5 w-2.5 rounded-full bg-slate-800" />
        ...
        <header className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-700 bg-slate-950 px-5 pb-3 pt-9">
          <h1 className="flex items-center gap-2 text-lg font-extrabold text-slate-100">
            <Send className="text-blue-400" size={20} />
            Money Pilot
          </h1>
          <div
            className="flex h-7 w-7 items-center justify-center rounded-full bg-slate-800 text-[10px] font-bold uppercase text-slate-200"
            title={userEmail}
          >
            {avatarLabel}
          </div>
        ...
        <nav className="absolute bottom-0 z-10 flex w-full justify-between border-t border-slate-700 bg-slate-950 px-6 py-2">
